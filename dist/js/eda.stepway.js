						...
						angular.extend(editControlModal, {
							...
							resolve: {
								columns: function columns() {
									return _this.prepareExistingColumns(_nyaSelect.temporyConfig.referenceId);
								},
...
$__System.register('18', [], function (_export) {
	...
	function easyFormSteWayConfig($translateProvider) {
		...
		function controlsList() {
			var controls = [{ name: 'empty', enabled: true }, { name: 'Header', enabled: true }, { name: 'Subtitle', enabled: true }, { name: 'TextInput', enabled: true }, { name: 'Number', enabled: true }, { name: 'Year', enabled: true }, { name: 'Password', enabled: true }, { name: 'Email', enabled: true }, { name: 'Date', enabled: true }, { name: 'Texarea', enabled: true }, { name: 'RichTextEditor', enabled: true }, { name: 'Radio', enabled: true }, { name: 'Checkbox', enabled: true }, { name: 'BasicSelect', enabled: true }, { name: 'GroupedSelect', enabled: true }];
			return controls;
		}
	...
	return {
		...
		execute: function () {
			...
			editControlModalController = (function () {
				function editControlModalController($uibModalInstance, nyaSelect, toaster, selectOptionManage, $modalProxy, columns) {
				...
				_createClass(editControlModalController, [{
					...
					key: 'open',
					value: function open($event, position) {
						$event.preventDefault();
						$event.stopPropagation();
			...
			toInject = ['$uibModalInstance', 'nyaSelect', 'toaster', 'selectOptionManage', '$modalProxy', 'columns'];
...
$__System.register('1e', [], function (_export) {
	...
	return {
		...
		execute: function () {
			...
			_export('extractTemplateOptionDefaultValue', extractTemplateOptionDefaultValue);

	...
	return {
		...
		execute: function () {
			...
			editControlModalController = (function () {
				function editControlModalController($uibModalInstance, nyaSelect, toaster, selectOptionManage, $modalProxy, titleColumns, columns, activeLineColumnsCount) {
				...
				_createClass(editControlModalController, [{
					...
					value: function addNewOptionRadio() {
						var result = this.selectOptionManage.addNewOptionRadio(this.radioRowCollection, this.newOptionRadio, this.parentsBasic);
					...
					value: function addNewOptionBasicSelect() {
						var result = this.selectOptionManage.addNewOptionBasicSelect(this.basicSelectRowCollection, this.newOptionBasicSelect, this.parentsBasic);
						if (result.resultFlag === false) {
							this.toaster.pop({
								type: 'warning',
								timeout: 2000,
					...
					value: function addNewOptionGroupedSelect() {
						var result = this.selectOptionManage.addNewOptionGroupedSelect(this.groupedSelectRowCollection, this.newOptionGroupedSelect, '', this.parentsBasic);
						if (result.resultFlag === false) {
							this.toaster.pop({
								type: 'warning',
								timeout: 2000,
			...
			toInject = ['$uibModalInstance', 'nyaSelect', 'toaster', 'selectOptionManage', '$modalProxy', 'titleColumns', 'columns', 'activeLineColumnsCount'];
		...
		execute: function () {
			...
			selectOptionManage = (function () {
				...
				_createClass(selectOptionManage, [{
					...
					key: 'addNewOptionRadio',
					value: function addNewOptionRadio(selectObj, newOptionOptions, parentsBasic) {
						var fullResponse = {
							resultFlag: false,
							details: ''
						};
						var checkResult = this.validOption(selectObj, newOptionOptions.saisie);
					...
					key: 'addNewOptionBasicSelect',
					value: function addNewOptionBasicSelect(selectObj, newOptionOptions, parentsBasic) {
						var fullResponse = {
							resultFlag: false,
							details: ''
						};
					...
					key: 'addNewOptionGroupedSelect',
					value: function addNewOptionGroupedSelect(selectObj, newOptionOptions, newOptionGroup, parentsBasic) {
						var fullResponse = {
							resultFlag: false,
							details: ''
						};

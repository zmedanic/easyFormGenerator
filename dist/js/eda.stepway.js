	...
	return {
		...
		execute: function () {
			...
			editControlModalController = (function () {
				function editControlModalController($uibModalInstance, nyaSelect, toaster, selectOptionManage, $modalProxy, columns, activeLineColumnsCount) {
			...
			toInject = ['$uibModalInstance', 'nyaSelect', 'toaster', 'selectOptionManage', '$modalProxy', 'columns', 'activeLineColumnsCount'];

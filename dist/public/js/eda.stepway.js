					...
					value: function init() {
						...
						this.optionsSourceDbFormatConfig = {
							...
							onInitialize: function onInitialize(selectize) {
								...
								var columns = edaController.prepareExistingColumns(null);
								...
								if (formFormatConfigIndex > 0) {
									angular.forEach(edaController.configuration.idFormat, function (formatPart) {
								...
								angular.forEach(edaController.fieldsSpecial, function (field) {
									field.count++;
									field.index++;
						...
						angular.extend(editControlModal, {
							...
							resolve: {
								...
								allOptions: function allOptions() {
									return _this2.prepareAllOptions();
								}
							}
						});

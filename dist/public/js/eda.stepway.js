...
$__System.register("5", [], function (_export) {
  ...
  return {
    ...
    execute: function () {
      ...
      // && model[options.key || index].indexOf($index) == -1}
	...
	return {
		...
		execute: function () {
			...
			editControlModalController = (function () {
				function editControlModalController($uibModalInstance, nyaSelect, toaster, selectOptionManage, $modalProxy, titleColumns, columns, activeLine, activeColumn, activeLineColumnsCount) {
			...
			toInject = ['$uibModalInstance', 'nyaSelect', 'toaster', 'selectOptionManage', '$modalProxy', 'titleColumns', 'columns', 'activeLine', 'activeColumn', 'activeLineColumnsCount'];

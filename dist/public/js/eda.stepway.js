			...
			editControlModalController = (function () {
				...
				_createClass(editControlModalController, [{
					...
					value: function addNewOptionRadio() {
						var result = this.selectOptionManage.addNewOptionRadio(this.radioRowCollection, this.newOptionRadio.saisie, this.parentsBasic);
					...
					value: function addNewOptionBasicSelect() {
						var result = this.selectOptionManage.addNewOptionBasicSelect(this.basicSelectRowCollection, this.newOptionBasicSelect.saisie, this.parentsBasic);
						if (result.resultFlag === false) {
							this.toaster.pop({
								type: 'warning',
								timeout: 2000,
					...
					value: function addNewOptionGroupedSelect() {
						var result = this.selectOptionManage.addNewOptionGroupedSelect(this.groupedSelectRowCollection, this.newOptionGroupedSelect.saisie, '', this.parentsBasic);
						if (result.resultFlag === false) {
							this.toaster.pop({
								type: 'warning',
								timeout: 2000,
		...
		execute: function () {
			...
			selectOptionManage = (function () {
				...
				_createClass(selectOptionManage, [{
					...
					key: 'addNewOptionRadio',
					value: function addNewOptionRadio(selectObj, newOptionText, parentsBasic) {
						var fullResponse = {
							resultFlag: false,
							details: ''
						};
					...
					key: 'addNewOptionBasicSelect',
					value: function addNewOptionBasicSelect(selectObj, newOptionText, parentsBasic) {
						var fullResponse = {
							resultFlag: false,
							details: ''
						};
					...
					key: 'addNewOptionGroupedSelect',
					value: function addNewOptionGroupedSelect(selectObj, newOptionText, newOptionGroup, parentsBasic) {
						var fullResponse = {
							resultFlag: false,
							details: ''
						};
